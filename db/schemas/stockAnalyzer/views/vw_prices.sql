...
select trades.ticker, periods.id as period_id, periods.name as period_name, dimention_link_id,
...
from trades inner join periods on (trades.dtm between periods.begin_dtm and periods.end_dtm)
group by trades.ticker, periods.id, periods.name, dimention_link_id;
